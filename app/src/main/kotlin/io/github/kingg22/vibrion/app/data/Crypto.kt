...
object Crypto {
    ...
    private fun getKey() = (keyStore.getEntry(KEY_ALIAS, null) as? KeyStore.SecretKeyEntry)?.secretKey

    private fun requireKey() = getKey() ?: createKey()
    ...
    @JvmName("-decrypt")
    fun ByteArray.decrypt() = decrypt(this)
}
