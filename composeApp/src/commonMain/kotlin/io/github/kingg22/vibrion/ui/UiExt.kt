...
/**
 * A [listSaver] for [SnapshotStateList].
 *
 * This allows a [androidx.compose.runtime.mutableStateListOf] to be saved and restored across configuration changes or process death
 * when used with [androidx.compose.runtime.saveable.rememberSaveable].
 *
 * @param Saveable The type of elements in the list. Must be saveable according to [androidx.compose.runtime.saveable.Saver]
 */
fun <Saveable> saverMutableList() = listSaver<SnapshotStateList<Saveable>, Saveable>(
    save = { it.toList() },
